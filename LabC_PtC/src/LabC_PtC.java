...
public String toString() {
    ...
    public static void main(String[] args) {
        int[] x = {4,2,7};
        int[] y = {4,9,3};
        MathVector vectorNO1 = new MathVector(x);
        System.out.println(vectorNO1);
        MathVector vectorNO2 = new MathVector(y);
        System.out.println(vectorNO2);

        MathVector added= vectorNO1.add(vectorNO2);
        System.out.println(added);

        System.out.println("To String Method: " + vectorNO1.toString());

        MathVector fills = MathVector.filled(4,6);
        System.out.println(fills);

        System.out.println("it is: " + vectorNO2.at(0));

        double mags = vectorNO2.magnitude();
        System.out.println(mags);

        MathVector parselam= MathVector.parse("32,59,69");
        System.out.println(parselam);


        MathVector randrand = MathVector.random(4,2,10);
        System.out.println(randrand);
